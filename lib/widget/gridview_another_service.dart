...
class GridviewAnotherService extends StatefulWidget {
  const GridviewAnotherService({Key key}) : super(key: key);

  @override
  _GridviewAnotherServiceState createState() => _GridviewAnotherServiceState();
}

class _GridviewAnotherServiceState extends State<GridviewAnotherService> {
  @override
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Text('Dịch vụ khác', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),),
          ),
          Padding(
